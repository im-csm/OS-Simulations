...
int firstFit(int* blocks, int* block_count, int* mem, int d, double v, int n){
    ...
    // Find the first hole that fits the new block
...
int main(int argc, char** argv) {
    ...
    while(x > 0){
        while(firstFit(blocks, &block_count, mem, d, v, n));
